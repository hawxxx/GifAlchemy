...
export const ANIMATION_PRESETS: AnimationPresetOption[] = [
  ...
  { id: "scale-in", label: "Scale In", description: "Smooth scale from smaller size" },
  { id: "rotate-in", label: "Rotate In", description: "Rotate into place" },
  { id: "flicker", label: "Flicker", description: "Rapid opacity jitter" },
